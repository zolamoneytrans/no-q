...
<head>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        h1 { font-size: 1.8rem; margin-bottom: 1.5rem; color: #6d28d9; display: flex; align-items: center; gap: 0.5rem; }
        ...
        .stat-card .value { font-size: 1.8rem; font-weight: 800; color: #6d28d9; }
        .stat-card .label { color: #5b21b6; font-size: 0.8rem; margin-top: 0.3rem; }
        ...
        .amount { font-weight: 800; color: #6d28d9; font-size: 1.1rem; }
...
<body>
    <header class="app-header">
        ...
        <nav class="nav-links" id="navLinks">
            ...
            <a href="payments.php" style="background:rgba(139,92,246,0.1);">Payments</a>
