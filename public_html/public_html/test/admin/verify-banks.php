...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        tr:hover { background: rgba(30,60,114,0.02); }
        ...
        .btn-verify:hover { background: #45a049; transform: scale(1.02); }
        .btn-unverify { background: #ff9800; color: white; }
        .btn-unverify:hover { background: #fb8c00; transform: scale(1.02); }
        .btn-reject { background: #f44336; color: white; }
        .btn-reject:hover { background: #da190b; transform: scale(1.02); }
        
        /* Bank Details */
        .bank-details { font-size: 0.85rem; color: #2c3e50; line-height: 1.5; }
        .bank-details strong { color: #1e3c72; }
        ...
        .success { background: #e8f5e9; color: #1e3c72; border-left: 4px solid #4caf50; }
        ...
        .empty-state i { font-size: 3rem; color: #1e3c72; margin-bottom: 1rem; display: block; opacity: 0.5; }
...
<body>
    <header class="app-header">
        ...
        <nav class="nav-links" id="navLinks">
            ...
            <a href="verify-banks.php" style="background:rgba(42,82,152,0.1);"><i class="fa-regular fa-building-columns"></i> Verify Banks</a>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td data-label="Business">
                                    ...
                                    <small style="color: #666;"><?= htmlspecialchars($biz['email']) ?></small>
                                </td>
