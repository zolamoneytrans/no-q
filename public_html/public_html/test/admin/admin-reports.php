...
$pie_colors = ['#1e3c72', '#0e010f', '#333c02', '#ff9800', '#4caf50', '#f44336', '#9c27b0', '#2196f3', '#795548', '#607d8b'];
...
<body>
    ...
    <script>
        ...
        // Top Businesses Pie Chart – with distinct colors
        var pieLabels = <?= json_encode($top_business_names) ?>;
        var pieData = <?= json_encode($top_business_revenue) ?>;
        var pieColors = <?= json_encode($chart_colors) ?>;
