    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        @media (max-width: 768px) {
            ...
            .app-header { padding: 0.8rem 1rem; position: }
            .nav-links { 
                display: none; 
                width: 100%; 
                flex-direction: column; 
        ...
        h1 { font-size: 1.8rem; margin-bottom: 1rem; color: #1e3c72; display: flex; align-items: center; gap: 0.5rem; }
        ...
        .search-form .btn-clear { background: #777; }
        ...
        .stat-card .number { font-size: 1.5rem; font-weight: 800; color: #1e3c72; }
        .stat-card .label { font-size: 0.7rem; color: #2c3e50; }
        ...
        .amount { font-weight: 700; color: #1e3c72; }
...
<body>
    <header class="app-header">
        ...
        <nav class="nav-links" id="navLinks">
            ...
            <a href="bookings.php" style="background:rgba(42,82,152,0.1);">Bookings</a>
