...
");
$pay_stmt->execute([$booking_id, $user_id, $booking['total_amount']]);
    ...
    <body>
        <div class='container'>
            ...
            <div class='content'>
                ...
                <strong>Amount Paid:</strong> R " . number_format($booking['total_amount'], 2) . "</p>
...
<body>
    <div class="container">
        ...
        <p>Your payment of <strong>R <?= number_format($booking['total_amount'], 2) ?></strong> has been received.</p>
