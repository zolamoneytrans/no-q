    ...
    <div class="container">
        <div class="card">
            ...
            <div class="meta">
                ...
                <?php else: ?>
                    <span style="margin-left:1rem; background:#ff9800; color:white; padding:0.2rem 1rem; border-radius:30px; font-size:0.8rem;">New</span>
                <?php endif; ?>
            </div>
            ...
            <?php if ($notification['link']): ?>
                <a href="<?= htmlspecialchars($notification['link']) ?>" class="btn"><i class="fa-regular fa-arrow-right"></i> Go to related page</a>
            <?php endif; ?>
            <div style="margin-top:2rem;">
                <a href="notifications.php" style="color:#1e3c72;">← Back to notifications</a>
            </div>
        </div>
    </div>
